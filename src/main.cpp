...
int keymap[] = {
        KEY_TAB,	    KEY_QUOTE,     KEY_COMMA,             KEY_PERIOD,	KEY_P,         KEY_Y,     KEY_F,     KEY_G,     KEY_C,     KEY_R,           KEY_L,         KEY_SLASH,
        ...
        KEY_ESC,        KEY_LEFT_GUI,  KEY_LEFT_GUI,  MODIFIERKEY_LEFT_CTRL, KEY_LEFT_ALT, KEY_BACKSPACE, KEY_ENTER, KEY_SPACE, KEY_SPACE, KEY_RIGHT_ARROW, KEY_RIGHT_ALT, KEY_RIGHT_CTRL
};
